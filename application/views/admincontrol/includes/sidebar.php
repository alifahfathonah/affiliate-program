 ...
 <!-- ========== Left Sidebar Start ========== -->
            <div class="left side-menu">
                        ...
                        <ul>
                           ...
                           <li><a href="<?php echo base_url();?>" target="_blank" class="waves-effect"><i class="mdi mdi-web"></i><span> <?=__('admin.view_site') ?></a></li>
                            <li><a href="<?php echo base_url('firstsetting') ?>" class="waves-effect" >
                                ...
                                <span><?= __('admin.menu_firstsetting') ?><span class="badge badge-danger float-right">DO NOW</span></a></li>
		        ...
		        <li class="custom-menu-link">
		        	<a href=""> <i class="mdi mdi-layers"></i><span class="waves-effect" id="notynew"></span>
			        <span>SCRIPT VERSION:</span><span class="badge badge-primary float-right"><?php echo SCRIPT_VERSION ?></span></a>
		        </li>
		        
		        <li class="mt-3">
					<a href="http://blankrefer.com/?https://affiliatepro.org/knowledge-base/" class="waves-effect" target="_blank"><i class="mdi mdi-layers"></i> 
						<span> <?= __('DOCUMENT') ?> </span>
					<span class="badge badge-danger float-right">HELP</span></a> </a>
				</li>
	                                ...
	                                <div class="col-sm-12">
	                                    <div class="page-title-box">
	                                        <div class="iconify float-left">
                                          		<a href="JavaScript: location.reload(true);"><i class="mdi mdi-refresh" data-inline="false"></i></a>
	                                        </div>
	                                        <h4 class="page-title pull-left"><?= $pageSetting[$pageKey]['title'] ?></h4>
	                                        <div class="float-right dashboard-tool">
	                                        	<?php if($pageKey == 'admincontrol_dashboard'){ ?>
                                        			...
                                        			<div class="d-inline-block setting-tools">
                                        				<button class="btn btn-blue-grey btn-sm btn-setting" data-toggle="tooltip" title='Dashboard Settings' data-key='live_dashboard' data-type='admin'>
