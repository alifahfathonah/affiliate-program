							...
							<div class="tab-content">
							  <div class="tab-pane col-sm-12 active" id="home">
											...
											<div class="form-group">
												...
												<select class="form-control" name="program_id">
													...
													<?php foreach ($programs as $key => $program) { ?>
														<option <?= (isset($tool) && $tool['program_id'] == $program['id']) ? 'selected' : '' ?> value="<?= $program['id'] ?>"><?= $program['name'] ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div>
											<label class="radio-inline"> <input type="radio" checked="" name="status" value="0"> <?= __('admin.disable') ?> </label>
											<label class="radio-inline"> <input type="radio" <?= (isset($tool) && $tool['status']) ? 'checked' : '' ?> name="status" value="1"> <?= __('admin.enable') ?> </label>
										</div>
									</div>
									...
									<?php 
										$allow_for = array_filter(explode(",", $tool['allow_for']));
									?>
									<div class="form-group">
													...
													<tbody>
														<?php for ($level =1; $level <= $max_level; $level++) { ?>
															<tr>
																...
																<!-- <td><input type="number" step="any" name="referlevel_<?= $level ?>[sale_commition]" value="<?php echo ${"referlevel_". $level}['sale_commition'] ?>" class="form-control" /></td>
																<td><input type="number" step="any" name="referlevel_<?= $level ?>[ex_commition]" value="<?php echo ${"referlevel_". $level}['ex_commition'] ?>" class="form-control" /></td>
																<td><input type="number" step="any" name="referlevel_<?= $level ?>[ex_action_commition]" value="<?php echo ${"referlevel_". $level}['ex_action_commition'] ?>" class="form-control" /></td> -->
											...
											<?php if(false){ ?>
												<div class="row">
													...
													<div class="col-sm-3">
														<div class="comm-cube-box">
															<div class="form-group">
																<label  class="col-form-label">External Click</label>
															...
															<?php foreach (array('1','2','3') as $key => $v) { ?>
																<fieldset>
																	<legend><?= __('admin.level') ?> <?= $v ?>:</legend>
																	<div class="form-group">
																		<label  class="col-form-label">External Click Commission  (<?= $CurrencySymbol ?></span>)</label>
													...
													<div class="col-sm-3">
														<div class="comm-cube-box">
															<div class="form-group">
																<label  class="col-form-label">External Action Click</label>
															...
															<?php foreach (array('1','2','3') as $key => $v) { ?>
																<fieldset>
																	<legend><?= __('admin.level') ?> <?= $v ?>:</legend>
																	<div class="form-group">
																		<label  class="col-form-label">External Action Click Commission  (<?= $CurrencySymbol ?></span>)</label>
            ...
            xhr: function (){
                ...
                jqXHR.upload.addEventListener( "progress", function ( evt ){
                    if ( evt.lengthComputable ){
                        ...
                        $('.loading-submit').text(percentComplete + "%").show();
                    }
                }, false );
