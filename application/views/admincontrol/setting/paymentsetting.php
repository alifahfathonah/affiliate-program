						...
						<div class="tab-content">
										...
										<div class="theme-box <?= $login['front_template'] == $theme['id'] ? 'selected' : '' ?> ">
											...
											<div class="theme-bottom">
												...
												<div class="theme-buttons">
													...
													<a href="<?= base_url('?tmp_theme='. $theme['id']) ?>" target="_blank" class="theme-btn btn-theme-preview">Live Preview</a>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="tab-pane p-3" id="email-setting" role="tabpanel">
								...
								<!-- <div class="form-group">
									...
									<input name="email[smtp_password]" value="<?php echo $email['smtp_password']; ?>" class="form-control" type="text">
								</div> -->
								<div class="form-group">
									<label  class="control-label"><?= __('admin.smtp_password') ?></label>
									<div class="input-group password-group">
									  	<input type="password" class="form-control" name="email[smtp_password]" value="<?php echo $email['smtp_password']; ?>">
