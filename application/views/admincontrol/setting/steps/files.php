	...
	<form id="update-files" enctype="multipart/form-data">
		<div class="form-group">
			<div class="file-upload-wrapper-container">
				<p class="m-0 text-muted"><?= __('admin.updatefile_ins1') ?></p>
				<div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?= base_url('assets/images/installversion2.png') ?>" class='img-responsive w-100'>
      </div>
...
<script type="text/javascript">
	...
	function updateProgressBar(percentComplete) {
		...
		if(percentComplete >=99 ){
			text = 'Extracting zip file...';
		}

		$('.progress-w-bar .title').text(text);
	}
	...
	function migrateFiles(t) {
		...
		$.ajax({
			...
			contentType: false,
    		processData: false,
			beforeSend:function(){$this.btn("loading");$(".progress-w").show()},
