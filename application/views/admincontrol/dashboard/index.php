...
<!--<div class="row">
    <div class="col-sm-12">
        <button class="btn  btn-danger open-databaseclear">Reset Script Data</button>
    </div>
</div>-->
    ...
    <div class="modal-dialog">
        <div class= "modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Reset All Script Data</h4>
            ...
            <div class="col-xl-3">
                ...
                <div class="mini-stat clearfix bg-white">
                    <div class="mini-stat-info text-center">
                        <h5 class="counter mt-0 text-primary ajax-total_balance"><?php echo $totals['full_total_balance'] ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-xl-3">
       ...
       ?>
        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    <div class="mini-stat-info text-center">
                        <h5 class="counter mt-0 text-primary ajax-_t_paid_comm"><?php echo c_format($_t_paid_comm) ?></h5>
                        <h6><?php echo __( 'admin.total_paid_commission') ?></h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    <div class="mini-stat-info text-center">
                        <h5 class="counter mt-0 text-primary ajax-_t_unpaid_comm"><?php echo c_format($_t_unpaid_comm) ?></h5>
                        <h6><?php echo __( 'admin.total_unpaid_commition' ) ?></h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    <div class="mini-stat-info text-center">
                        <h5 class="counter mt-0 text-primary ajax-_t_request_comm"> <?php echo c_format($_t_request_comm) ?></h5>
                        <h6><?php echo __( 'admin.total_in_request_commition' ) ?></h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    <div class="mini-stat-info text-center">
                        <h5 class="counter mt-0 text-primary ajax-_t_total_commission"><?php echo c_format($_t_total_commission) ?></h5>
                        <h6><?= __('admin.total_affiliates_comm') ?></h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card body">
            ...
            <script type="text/javascript">
                $(".open-databaseclear").on("click",function(){
                    ...
                    $container.find(".password-view").addClass('d-none');
                });
