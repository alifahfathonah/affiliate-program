				...
				<div class="form">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label  class="col-form-label"><?= __('admin.body_background_color') ?></label>
							<input name="emailsetting[bg_color]" value="<?php echo $emailsetting['bg_color']; ?>" class="form-control" type="text">
						</div>
						
						<div class="form-group">
							<label  class="col-form-label"><?= __('admin.footer_background_color') ?></label>
							<input name="emailsetting[bg_footer]" value="<?php echo $emailsetting['bg_footer']; ?>" class="form-control" type="text">
						</div>
						<div class="form-group">
