                ...
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <form class="form-horizontal m-t-20 login-form" action="" >
                            ...
                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-sm-7 m-t-20">
                                    <a href="javascript:void(0)" onclick="_open('forget')" class="text-muted"><i class="mdi mdi-lock"></i> <small>Forgot your password ?</small></a>
                                </div>
                            </div>
                        </form>
                        ...
                        <form class="form-horizontal m-t-20 forget-form" action="" >
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-danger btn-block waves-effect waves-light" type="submit">Forget Password</button>
                                </div>
                            </div>

                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-sm-7 m-t-20">
                                    <a href="javascript:void(0)" onclick="_open('login')" class="text-muted"><i class="mdi mdi-lock"></i> <small>Back to Login </small></a>
                                </div>
                            </div>
                        </form>
                    </div>
