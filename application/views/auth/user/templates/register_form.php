<form action="" method="POST" role="form" class="reg_form" novalidate="">
	...
	<?php foreach ($data as $key => $value) { 
		...
		$_customValue = $ivalue;
		switch ($value['type']) {
			case 'header': echo  $fields[strtolower($label)]; break;
			case 'text':
	...
	<?php if(!isset($edit_view)){ ?>
		...
		<div class="form-group">
			<div class="checkbox">
				<label class="reg-agree-label">
					...
					<a href="<?= base_url('term-condition') ?>" target=_blank><?= __('user.affiliate_policy') ?></a>
				</label>
			</div>
		</div>
		...
		<?php if (isset($allow_back_to_login)) { ?>
			<div class="register-form">
				<button type="submit" class="btn btn-primary btn-registration btn-submit">Submit</button>
