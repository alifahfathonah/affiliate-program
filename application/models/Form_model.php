...
class Form_model extends MY_Model{
    ...
    public function getForms($id = 0){
        ...
        $sql = "SELECT 
            ...
            (SELECT count(op.commission) FROM order_products op WHERE op.form_id = o.form_id ".$where.") AS count_commission ,
    ...
    public function getFormCoupons(){
        return $this->db->query("SELECT o.* FROM `form_coupon` o  ")->result_array();
    }
