...
CREATE TABLE `affiliateads` (
  ...
  `affiliateads_type` varchar(255) DEFAULT NULL,
  `affiliateads_metadata` longtext,
  `affiliateads_status` varchar(255) DEFAULT NULL,
  `affiliateads_ipaddress` varchar(255) DEFAULT NULL,
...
CREATE TABLE `clicks_views` (
  ...
  `clicks_views_type` varchar(255) DEFAULT NULL,
  `clicks_views_status` int(11) DEFAULT NULL,
  `clicks_views_click` int(11) DEFAULT NULL,
  `clicks_views_view` int(11) NOT NULL,
  `clicks_views_sale` varchar(255) DEFAULT NULL,
  `clicks_views_referrer` text,
  `clicks_views_user_agent` text,
  `clicks_views_os` text,
  `clicks_views_browser` text,
  `clicks_views_isp` text,
  `clicks_views_ipaddress` varchar(255) DEFAULT NULL,
  ...
  `clicks_views_click_commission` varchar(255) DEFAULT NULL,
  `clicks_views_sale_commission` varchar(255) DEFAULT NULL,
  `clicks_views_data_commission` varchar(255) DEFAULT NULL,
...
(1, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, 1, '2019-02-12 15:07:47');
...
CREATE TABLE `form` (
  ...
  `fevi_icon` varchar(50) NOT NULL,
  `sale_commision_type` varchar(50) NOT NULL,
  `sale_commision_value` double NOT NULL,
  `click_commision_type` varchar(50) NOT NULL,
  `click_commision_ppc` double NOT NULL,
  `click_commision_per` double NOT NULL,
  `form_recursion_type` varchar(255) NOT NULL,
  `form_recursion` varchar(255) NOT NULL,
  `recursion_custom_time` bigint(20) NOT NULL,
  `recursion_endtime` timestamp NULL DEFAULT NULL,
  `product` text,
  `coupon` text NOT NULL,
  `allow_for` text NOT NULL,
...
CREATE TABLE `integration_clicks_action` (
  ...
  `product_id` double(30,0) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `integration_orders` (
  ...
  `product_ids` varchar(888) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total` double NOT NULL,
...
CREATE TABLE `integration_programs` (
  ...
  `commission_number_of_click` int(11) NOT NULL,
  `commission_click_commission` double NOT NULL,
  `click_status` int(1) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `integration_tools` (
  ...
  `action_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `allow_for` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `language` (`id`, `name`, `is_default`, `flag`, `status`) VALUES
(1, 'English', 1, './assets/vertical/assets/images/flags/lr.png', 1);
...
INSERT INTO `mail_templates` (`id`, `name`, `subject`, `text`, `admin_subject`, `client_subject`, `client_text`, `admin_text`, `shortcode`) VALUES
...
CREATE TABLE `pagebuilder_theme_page` (
  ...
  `meta_tag_title` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_tag_description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_tag_keywords` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `payment_detail` (
  ...
  `payment_ifsc_code` varchar(255) NOT NULL,
  `payment_status` int(11) NOT NULL,
  `payment_ipaddress` varchar(20) NOT NULL,
...
CREATE TABLE `product` (
  ...
  `on_store` int(1) NOT NULL DEFAULT '0',
  `downloadable_files` text NOT NULL,
  `allow_shipping` int(1) NOT NULL DEFAULT '1',
  `allow_upload_file` int(1) NOT NULL,
...
CREATE TABLE `productslog` (
  ...
  `productslog_referrer` text,
  `productslog_user_agent` text,
  `productslog_os` text,
  `productslog_browser` text,
  `productslog_isp` text,
  `productslog_ipaddress` varchar(255) DEFAULT NULL,
...
CREATE TABLE `product_media_upload` (
  ...
  `product_media_upload_os` text,
  `product_media_upload_browser` text,
  `product_media_upload_isp` mediumtext
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rating` (
  ...
  `rating_email` varchar(255) DEFAULT NULL,
  `products_id` int(11) DEFAULT NULL,
  `rating_status` int(11) DEFAULT NULL,
  `rating_number` int(11) NOT NULL,
  `rating_comments` text,
  `rating_referrer` text,
  `rating_user_agent` text,
  `rating_os` text,
  `rating_browser` text,
  `rating_isp` text,
  `rating_ipaddress` varchar(255) DEFAULT NULL,
...
(1, 'name', 'YOUR WEBSITE NAME', 'site', 1, '77.127.103.146'),
(2, 'notify_email', '', 'site', 1, '77.127.103.146'),
(3, 'footer', '', 'site', 1, '77.127.103.146'),
(4, 'meta_description', '', 'site', 1, '77.127.103.146'),
(5, 'meta_keywords', '', 'site', 1, '77.127.103.146'),
(6, 'meta_author', '', 'site', 1, '77.127.103.146'),
(7, 'google_analytics', '', 'site', 1, '77.127.103.146'),
(8, 'logo', '', 'site', 1, '77.124.100.12'),
...
(13, 'product_commission_type', '', 'productsetting', 1, '77.127.103.146'),
(14, 'product_commission', '', 'productsetting', 1, '77.127.103.146'),
(15, 'product_ppc', '', 'productsetting', 1, '77.127.103.146'),
(16, 'product_noofpercommission', '', 'productsetting', 1, '77.127.103.146'),
...
(21, 'from_email', '', 'email', 1, '77.127.103.146'),
(22, 'from_name', '', 'email', 1, '77.127.103.146'),
(23, 'smtp_hostname', '', 'email', 1, '77.127.103.146'),
(24, 'smtp_username', '', 'email', 1, '77.127.103.146'),
(25, 'smtp_password', '', 'email', 1, '77.127.103.146'),
(26, 'smtp_port', '', 'email', 1, '77.127.103.146'),
(27, 'heading', 'Affiliate Terms & Condition', 'tnc', 1, '77.127.103.146'),
(28, 'content', '<p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><div><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p></div><div><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p></div><div><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p><p>TERM AND CONDITION TERM AND CONDITION  TERM AND CONDITION TERM AND CONDITION</p></div><div><br></div>', 'tnc', 1, '77.127.103.146'),
(29, 'payment_mode', 'sandbox', 'paymentsetting', 1, '77.125.48.104'),
(30, 'text_list', '', 'login', 1, '103.251.19.60'),
(31, 'name', 'Affiliate Pro Script Store', 'store', 1, '77.127.103.146'),
(32, 'title', 'Welcome To Affiliate Pro Script Store', 'store', 1, '77.127.103.146'),
(33, 'content', '<p><font color=\"#333333\">You have a full online store with Affiliate Pro Script</font></p><p><font color=\"#333333\">You can add products, add forms, add coupons, add multiple currency and more.....</font></p><p><font color=\"#333333\">you can set live payments methods using PayPal.</font></p><p><font color=\"#333333\">you can use offline checkout using Bank Transfer.</font></p><p><font color=\"#333333\">You can set any commission you want to any product in the store, in a fixed commission or in percentage.</font></p><p><font color=\"#333333\">Your clients will be able to register, to add to cart, to check out, to pay live, to view orders on the panel and more.</font></p><p><font color=\"#333333\">So if you don\'t have an External store from your own like WooCommerce, Magento, or else, so you more then welcome to use the script store.</font></p><p><font color=\"#333333\"><br></font></p>', 'store', 1, '77.127.103.146'),
(34, 'footer', 'Affiliate  © ALL RIGHTS RESERVED', 'store', 1, '77.127.103.146'),
(35, 'about_content', '<p>Every business owner wants to maximize its profits and sales. That is the essence of business after all. The affiliate script helps you actualize this with no much hassle. This the hosted software program is ideal for those out to make some extra bucks from their web visitors.</p><div class=\"info-box-text\">The affiliate clone is innovatively built \r\nuniquely to help you, the affiliate, maximize the full earning potential\r\n of any affiliate program. With the affiliate clone utility, you can \r\nprotect your affiliate links and establish links to order or product \r\npages at the click of a button.</div><div class=\"info-box-text\"><br></div><div class=\"info-box-text\">Every successful business website has an integrated PHP affiliate system. This robust and powerful software is the secret behind successful leads, sales, and traffic for many websites. You can have it today and watch your profits grow at an \r\nexponentially.</div>', 'store', 1, '77.127.103.146'),
(36, 'contact_content', '<p>\"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?\"</p>', 'store', 1, '77.127.103.146'),
(37, 'policy_content', '<p>\"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?\"</p><p></p>', 'store', 1, '77.127.103.146'),
(38, 'logo', '', 'store', 1, '77.124.38.225'),
(40, 'favicon', '', 'store', 1, '103.232.127.233'),
(41, 'content', '', 'login', 1, '77.126.80.25'),
(42, 'bg_color', '#4169E1', 'login', 1, '103.251.19.4'),
(43, 'footer', 'AFFILIATE PRO 2019 ©  ALL RIGHTS RESERVED', 'login', 1, '77.126.80.25'),
...
(48, 'heading', 'WELCOME TO OUR AFFILIATE PLAIN', 'loginclient', 1, '77.125.15.123'),
(49, 'content', '<p>Welcome To our Affiliate program registration panel</p><p>Feel free to register and earn money with us</p><p>wish you luck</p><p></p><p><br></p><p><br></p><p></p>', 'loginclient', 1, '77.125.15.123'),
...
(56, 'footer', 'AFFILIATE PRO 2019 © ALL RIGHTS RESERVED ', 'emailsetting', 1, '77.125.79.113'),
(57, 'logo', '', 'emailsetting', 1, '77.125.91.162'),
(79, 'commition', '', 'referlevel_1', 1, '77.127.103.146'),
(80, 'sale_commition', '', 'referlevel_1', 1, '77.127.103.146'),
(81, 'm_commition', '', 'referlevel_1', 1, '150.107.232.115'),
(82, 'commition', '', 'referlevel_2', 1, '77.127.103.146'),
(83, 'sale_commition', '', 'referlevel_2', 1, '77.127.103.146'),
(84, 'm_commition', '', 'referlevel_2', 1, '150.107.232.115'),
(85, 'commition', '', 'referlevel_3', 1, '77.127.103.146'),
(86, 'sale_commition', '', 'referlevel_3', 1, '77.127.103.146'),
(87, 'm_commition', '', 'referlevel_3', 1, '150.107.232.115'),
(88, 'click', '', 'referlevel', 1, '77.125.48.104'),
(89, 'm_click', '', 'referlevel', 1, '150.107.232.115'),
(90, 'product_commission_type', '', 'formsetting', 1, '77.127.103.146'),
(91, 'product_commission', '', 'formsetting', 1, '77.127.103.146'),
(92, 'product_ppc', '', 'formsetting', 1, '77.127.103.146'),
(93, 'product_noofpercommission', '', 'formsetting', 1, '77.127.103.146'),
(94, 'recaptcha', '', 'formsetting', 1, '77.127.103.146'),
(95, 'favicon', '', 'site', 1, '77.124.100.12'),
(96, 'affiliate_cookie', '360', 'store', 1, '77.127.103.146'),
...
(105, 'sale_type', 'percentage', 'referlevel', 1, '77.127.103.146'),
(106, 'ex_click', '0', 'referlevel', 1, '77.125.48.104'),
(107, 'ex_action_click', '0', 'referlevel', 1, '77.125.48.104'),
(108, 'ex_commition', '', 'referlevel_1', 1, '77.127.103.146'),
(109, 'ex_action_commition', '', 'referlevel_1', 1, '77.127.103.146'),
(110, 'ex_commition', '', 'referlevel_2', 1, '77.127.103.146'),
(111, 'ex_action_commition', '', 'referlevel_2', 1, '77.127.103.146'),
(112, 'ex_commition', '', 'referlevel_3', 1, '77.127.103.146'),
(113, 'ex_action_commition', '', 'referlevel_3', 1, '77.127.103.146'),
(114, 'logo', '', 'templates', 1, '77.127.29.106'),
(115, 'status', '1', 'store', 1, '77.127.103.146'),
(116, 'wallet_min_amount', '50', 'site', 1, '77.127.103.146'),
(117, 'wallet_min_message', '<p>You can not <b>withdraw </b>less than 50$</p>', 'store', 1, '103.251.59.244'),
(118, 'wallet_min_message', '<p xss=\"removed\"><span xss=\"removed\">You can not<span> </span></span><b xss=\"removed\">withdraw<span> </span></b><span xss=\"removed\">less than 50$</span></p>', 'site', 1, '77.127.103.146'),
(119, 'front_template', 'custom_1', 'login', 1, '77.127.103.146'),
(120, 'status', '1', 'referlevel', 1, '77.127.103.146'),
(121, 'disabled_for', '[]', 'referlevel', 1, '77.127.103.146'),
...
(124, 'google_analytics', '', 'store', 1, '77.127.103.146'),
(125, 'time_zone', 'Africa/Abidjan', 'site', 1, '77.127.103.146'),
...
(132, 'registration_status', '1', 'store', 1, '77.127.103.146'),
(133, 'default_action_status', '1', 'referlevel', 1, '77.127.103.146'),
(134, 'faceboook_pixel', '', 'site', 1, '77.127.103.146'),
(135, 'global_script', '', 'site', 1, '77.127.103.146'),
(136, 'global_script_status', '[]', 'site', 1, '77.127.103.146'),
(137, 'bg_left', 'rgb(29, 137, 228)', 'loginclient', 1, '77.125.15.123'),
(138, 'bg_right', 'rgb(119, 186, 246)', 'loginclient', 1, '77.125.15.123'),
(139, 'footer_bf', 'rgb(12, 52, 61)', 'loginclient', 1, '77.125.15.123'),
(140, 'footer_color', 'rgb(255, 242, 204)', 'loginclient', 1, '77.125.15.123'),
(141, 'btn_sendmail_bg', 'rgb(255, 242, 204)', 'loginclient', 1, '77.125.15.123'),
(142, 'btn_sendmail_color', 'rgb(255, 255, 255)', 'loginclient', 1, '77.125.15.123'),
(143, 'btn_backlogin_bg', 'rgb(204, 65, 37)', 'loginclient', 1, '77.125.15.123'),
(144, 'btn_backlogin_color', 'rgb(255, 255, 255)', 'loginclient', 1, '77.125.15.123'),
(145, 'btn_forgotlink_bg', 'rgb(147, 196, 125)', 'loginclient', 1, '77.125.15.123'),
(146, 'btn_forgotlink_color', 'rgb(255, 255, 255)', 'loginclient', 1, '77.125.15.123'),
(147, 'btn_signin_bg', 'rgb(255, 242, 204)', 'loginclient', 1, '77.125.15.123'),
(148, 'btn_signin_color', 'rgb(147, 196, 125)', 'loginclient', 1, '77.125.15.123'),
(149, 'btn_signup_bg', 'rgb(111, 168, 220)', 'loginclient', 1, '77.125.15.123'),
(150, 'btn_signup_color', 'rgb(244, 204, 204)', 'loginclient', 1, '77.125.15.123'),
(151, 'btn_registersubmit_bg', 'rgb(32, 18, 77)', 'loginclient', 1, '77.125.15.123'),
(152, 'btn_registersubmit_color', 'rgb(255, 217, 102)', 'loginclient', 1, '77.125.15.123'),
...
(155, 'heading_color', 'rgb(108, 78, 197)', 'loginclient', 1, '77.125.15.123'),
(156, 'input_text_color', 'rgb(106, 168, 79)', 'loginclient', 1, '77.125.15.123'),
(157, 'input_bg_color', 'rgb(182, 215, 168)', 'loginclient', 1, '77.125.15.123'),
(158, 'input_label_color', 'rgb(106, 168, 79)', 'loginclient', 1, '77.125.15.123'),
...
(164, 'header_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(165, 'header_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(166, 'header_language_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(167, 'header_currency_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(168, 'header_alert_icon', 'rgb(164, 194, 244)', 'adminside', 1, '123.201.226.15'),
(169, 'header_alert_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(170, 'header_alert_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(171, 'header_menu_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(172, 'header_menu_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(173, 'top_left_text', 'ADMIN PANEL', 'adminside', 1, '77.125.79.113'),
(174, 'top_left_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(175, 'top_left_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(176, 'sidebar_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(177, 'sidebar_menu_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(178, 'sidebar_menu_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(179, 'sidebar_menu_bottom_links_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(180, 'sidebar_menu_bottom_links_text_color', 'rgb(255, 255, 255)', 'adminside', 1, '77.125.79.113'),
(181, 'header_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(182, 'header_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(183, 'header_language_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(184, 'header_currency_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(185, 'header_alert_icon', 'hsv(65, 64%, 71%)', 'affiliateside', 1, '123.201.226.15'),
(186, 'header_alert_background_color', 'rgb(252, 204, 10)', 'affiliateside', 1, '77.125.79.113'),
(187, 'header_alert_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(188, 'header_menu_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(189, 'header_menu_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(190, 'top_left_text', 'AFFILIATE PANEL', 'affiliateside', 1, '77.125.79.113'),
(191, 'top_left_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(192, 'top_left_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(193, 'sidebar_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(194, 'sidebar_menu_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(195, 'sidebar_menu_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(196, 'sidebar_menu_bottom_links_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
(197, 'sidebar_menu_bottom_links_text_color', 'rgb(255, 255, 255)', 'affiliateside', 1, '77.125.79.113'),
(198, 'header_menu_dropdown_background_color', 'rgb(0, 100, 184)', 'adminside', 1, '77.125.79.113'),
(199, 'header_menu_dropdown_background_color', 'rgb(136, 99, 246)', 'affiliateside', 1, '77.125.79.113'),
...
(213, 'language_status', '1', 'store', 1, '77.127.103.146'),
(214, 'status', '0', 'storepayment_bank_transfer', 1, '77.127.103.146'),
(215, 'status', '0', 'storepayment_cod', 1, '77.127.103.146'),
(216, 'theme', '0', 'store', 1, '77.127.103.146'),
(217, 'autoacceptlocalstore', '0', 'referlevel', 1, '77.127.103.146'),
(218, 'autoacceptexternalstore', '0', 'referlevel', 1, '77.127.103.146'),
(219, 'autoacceptaction', '0', 'referlevel', 1, '77.127.103.146'),
(220, 'levels', '10', 'referlevel', 1, '77.127.103.146'),
(221, 'commition', '', 'referlevel_4', 1, '77.127.103.146'),
(222, 'sale_commition', '', 'referlevel_4', 1, '77.127.103.146'),
(223, 'ex_commition', '', 'referlevel_4', 1, '77.127.103.146'),
(224, 'ex_action_commition', '', 'referlevel_4', 1, '77.127.103.146'),
(225, 'commition', '', 'referlevel_5', 1, '77.127.103.146'),
(226, 'sale_commition', '', 'referlevel_5', 1, '77.127.103.146'),
(227, 'ex_commition', '', 'referlevel_5', 1, '77.127.103.146'),
(228, 'ex_action_commition', '', 'referlevel_5', 1, '77.127.103.146'),
(229, 'commition', '', 'referlevel_6', 1, '77.127.103.146'),
(230, 'sale_commition', '', 'referlevel_6', 1, '77.127.103.146'),
(231, 'ex_commition', '', 'referlevel_6', 1, '77.127.103.146'),
(232, 'ex_action_commition', '', 'referlevel_6', 1, '77.127.103.146'),
(233, 'commition', '', 'referlevel_7', 1, '77.127.103.146'),
(234, 'sale_commition', '', 'referlevel_7', 1, '77.127.103.146'),
(235, 'ex_commition', '', 'referlevel_7', 1, '77.127.103.146'),
(236, 'ex_action_commition', '', 'referlevel_7', 1, '77.127.103.146'),
(237, 'commition', '', 'referlevel_8', 1, '77.127.103.146'),
(238, 'sale_commition', '', 'referlevel_8', 1, '77.127.103.146'),
(239, 'ex_commition', '', 'referlevel_8', 1, '77.127.103.146'),
(240, 'ex_action_commition', '', 'referlevel_8', 1, '77.127.103.146'),
(241, 'commition', '', 'referlevel_9', 1, '77.127.103.146'),
(242, 'sale_commition', '', 'referlevel_9', 1, '77.127.103.146'),
(243, 'ex_commition', '', 'referlevel_9', 1, '77.127.103.146'),
(244, 'ex_action_commition', '', 'referlevel_9', 1, '77.127.103.146'),
(245, 'commition', '', 'referlevel_10', 1, '77.127.103.146'),
(246, 'sale_commition', '', 'referlevel_10', 1, '77.127.103.146'),
(247, 'ex_commition', '', 'referlevel_10', 1, '77.127.103.146'),
(248, 'ex_action_commition', '', 'referlevel_10', 1, '77.127.103.146'),
(249, 'sitekey', '', 'googlerecaptcha', 1, '77.127.103.146'),
(250, 'secretkey', '', 'googlerecaptcha', 1, '77.127.103.146'),
(251, 'admin_login', '0', 'googlerecaptcha', 1, '77.127.103.146'),
(252, 'affiliate_login', '0', 'googlerecaptcha', 1, '77.127.103.146'),
(253, 'affiliate_register', '0', 'googlerecaptcha', 1, '77.127.103.146'),
(254, 'client_login', '0', 'googlerecaptcha', 1, '77.127.103.146'),
(255, 'client_register', '0', 'googlerecaptcha', 1, '77.127.103.146'),
(256, 'bank_details', 'TEST 1 NATIONAL BANK  \r\n\r\nA/C NO: 07390100035702 \r\nA/C NAME: BANK NAME\r\nA/C TYPE: ACCOUNT TYPE\r\nIFSC CODE: BANK CODE', 'storepayment_bank_transfer', 1, '77.127.103.146'),
...
(263, 'status', '0', 'storepayment_stripes', 1, '77.127.103.146'),
...
(271, 'status', '0', 'storepayment_skrill', 1, '77.127.103.146'),
(272, 'status', '0', 'storepayment_paytm', 1, '77.127.103.146'),
(273, 'status', '0', 'storepayment_paypal', 1, '77.127.103.146'),
...
(289, 'product_recursion', '', 'productsetting', 1, '77.127.103.146'),
(290, 'recursion_custom_time', '0', 'productsetting', 1, '77.127.103.146'),
(294, 'form_recursion', '', 'formsetting', 1, '77.127.103.146'),
(295, 'recursion_custom_time', '0', 'formsetting', 1, '77.127.103.146'),
(296, 'recursion_endtime', '', 'productsetting', 1, '77.127.103.146'),
(297, 'recursion_endtime', '', 'formsetting', 1, '77.127.103.146'),
(298, 'additional_bank_details', '[\"TEST 2 NATIONAL BANK  \\r\\n\\r\\nA\\/C NO: 07390100035702 \\r\\nA\\/C NAME: BANK NAME\\r\\nA\\/C TYPE: ACCOUNT TYPE\\r\\nIFSC CODE: BANK CODE\"]', 'storepayment_bank_transfer', 1, '77.127.103.146'),
(299, 'proof', '0', 'storepayment_bank_transfer', 1, '77.127.103.146'),
(300, 'cost', '[]', 'shipping_setting', 1, '77.127.103.146'),
(301, 'allow_country', '[\"10\"]', 'shipping_setting', 1, '219.91.237.198'),
(302, 'shipping_in_limited', '0', 'shipping_setting', 1, '77.127.103.146'),
(303, 'shipping_error_message', 'Your country is not in our shipping list, you will not be able to order physical products.', 'shipping_setting', 1, '77.127.103.146');
INSERT INTO `setting` (`setting_id`, `setting_key`, `setting_value`, `setting_type`, `setting_status`, `setting_ipaddress`) VALUES
...
INSERT INTO `users` (`id`, `refid`, `type`, `firstname`, `lastname`, `email`, `username`, `password`, `phone`, `twaddress`, `address1`, `address2`, `ucity`, `ucountry`, `state`, `uzip`, `avatar`, `online`, `unique_url`, `bitly_unique_url`, `updated_at`, `google_id`, `facebook_id`, `twitter_id`, `umode`, `PhoneNumber`, `Addressone`, `Addresstwo`, `City`, `Country`, `StateProvince`, `Zip`, `f_link`, `t_link`, `l_link`, `product_commission`, `affiliate_commission`, `product_commission_paid`, `affiliate_commission_paid`, `product_total_click`, `product_total_sale`, `affiliate_total_click`, `sale_commission`, `sale_commission_paid`, `status`, `value`, `last_ping`, `created_at`) VALUES
(1, 0, 'admin', 'Admin', 'Admin', 'yourmail@yourmail.com', 'admin', '7479305b3e914c467c0cb2eba57b352b58e1ff37', '', '', '', '', '', '', '', '', '', '1', '', '', '0000-00-00 00:00:00', '', '', '', '', '85370425678', '', '', 'Lhokseumawe', '85', '', '54321', '', '', '', 0, 20.8, 0, 0, 0, 0, 28, 0, 0, 1, '', '2020-02-02 16:09:45', '2018-11-22 13:52:36');

CREATE TABLE `user_payment_request` (
  `user_payment_request_id` int(11) NOT NULL,
  `user_payment_request_user_id` int(11) DEFAULT NULL,
  `user_payment_request_amount` varchar(255) DEFAULT NULL,
  `user_payment_request_amount_type` varchar(255) DEFAULT NULL,
  `user_payment_request_amount_status` varchar(255) DEFAULT NULL,
  `user_payment_request_payment_mode` varchar(255) DEFAULT NULL,
  `user_payment_request_ipaddress` varchar(20) DEFAULT NULL,
  `user_payment_request_created_date` datetime DEFAULT NULL,
  `user_payment_request_updated_date` datetime DEFAULT NULL,
  `user_payment_request_user_agent` text,
  `user_payment_request_os` text,
  `user_payment_request_browser` text,
  `user_payment_request_isp` text,
  `user_payment_request_created_by` varchar(255) NOT NULL,
  `user_payment_request_updated_by` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `wallet` (
  ...
  `is_action` int(1) NOT NULL DEFAULT '0',
...
ALTER TABLE `setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=333;
